...
// `mapEmbedUrl`/`directionsUrl` come from SiteContent.contact (page-specific),
// `addressLines` from SiteSettings.contactInfo (chrome-level, shared with the
// footer) — same split as ChannelRail.
export default function MapFacade({ mapEmbedUrl, directionsUrl, addressLines }) {
